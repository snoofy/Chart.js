...
//			console.log('padding-left:'+this.xScalePaddingLeft);
//			console.log('padding-right:'+this.xScalePaddingRight);
			var isRotated = (this.xLabelRotation > 0),
				// innerWidth = (this.offsetGridLines) ? this.width - offsetLeft - this.padding : this.width - (offsetLeft + halfLabelWidth * 2) - this.padding,
				innerWidth = this.width - (this.xScalePaddingLeft + this.xScalePaddingRight),
				valueWidth = innerWidth/Math.max((this.valuesCount - ((this.offsetGridLines) ? 0 : 1)), 1),
				valueOffset = (valueWidth * index) + this.xScalePaddingLeft;
				console.log(index+' : '+valueOffset+' vc:'+this.valuesCount);
			...
			if ((this.xScaleSteps !== 'undefined') &&
				...
				console.log(index+' : '+valueOffset+' xssMax:'+xssMax);
			}
	...
	Chart.Type.extend({
		...
		initialize:  function(data){
			...
			helpers.each(data.datasets,function(dataset){
				...
				this.buildScale(data.labels, data.scaleSteps);
		...
		buildScale : function(labels, scaleSteps){
			if (typeof scaleSteps === 'undefined') {
				scaleSteps = null;
			}
			var self = this;
